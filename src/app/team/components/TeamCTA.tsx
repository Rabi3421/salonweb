          ...
          <div className="relative z-10">
            <div className="flex justify-center mb-5">
              <div className="w-14 h-14 rounded-full bg-white/20 flex items-center justify-center">
                <Icon name="UserGroupIcon" size={26} className="text-white" />
              </div>
            </div>
            <h2 className="font-display text-section-title text-white font-light mb-5">
              Want To Book With <span className="italic">Our Experts?</span>
            </h2>
            <p className="text-white/80 text-lg max-w-xl mx-auto mb-10">
              Choose your preferred service and mention your stylist request while booking. Our team
              will confirm availability by call or WhatsApp.
            </p>
